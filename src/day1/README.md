...
### Task 1
The device configured to send 500 years further into the past shows error message: 
...
### Task 2
The device repeats the same frequency change list over and over. To calibrate the device, you need to find the first frequency it reaches **twice**.
